...
/**
 * Created by Luis on 28/09/2016.
 */

public class Anuncio_content {
    private static final String LOGTAG = "LogsAndroid";
    public String post(String posturl,String id_usuario,String email){
...
/*El objeto HttpPost permite que enviemos una peticion de tipo POST a una URL especificada*/
            ...
            params.add(new BasicNameValuePair("ida",id_usuario));
